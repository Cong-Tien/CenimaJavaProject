...
import com.lecongtien.cinema.exceptions.CoEException;
 ...
 * The CsvUtils class provides utility methods for reading and writing CSV files.
 *
 * @author Tien Le
 *
 */
...
public class CsvUtils {
     ...
     * @param jsonConfigModel json config model corresponds to that excel file template
     * @param jsonConfigModel grap every thing it have. ex: mapping rule, start column, config type, ...
    ...
    public static <T> ExcelResponseModel readCsv(InputStream inputStream, ExcelConfigModel jsonConfigModel, Class<T> tClass) {
     ...
     * @param header is the header list to compare each column from the excel
     * @param jsonConfigModel grap every thing it have. ex: mapping rule, start column, config type, ...
     * @param error to contain error detail
     * @param <T> generics
     */
    private static <T> void handleColumnImport(int startColumn, String[] row, List<String> header, ExcelConfigModel jsonConfigModel, ExcelErrorDetail error, T t) {
     ...
     */
    private static <T> void handleIntegerValue(String cell, Method method, T t) throws IllegalAccessException, InvocationTargetException {
     ...
     * @param t stand for class has getDeclaredConstructor
     */
    private static <T> void handleDateValue(String cell, Method method, T t) throws IllegalAccessException, InvocationTargetException {
     ...
     * @author Phan Nguyen
     */
    private static <T> void handleDoubleValue(String cell, Method method, T t) throws IllegalAccessException, InvocationTargetException {
     ...
     * @author Phan Nguyen
     */
    private static <T> void handleEmailValue(String cell, String validation, Method method, T t) throws IllegalAccessException, InvocationTargetException {
     ...
     * @return config key if match with header or else return null
     * @param cell is the excel cell value
     * @return if configkey is require and cell is not null will return true or else it will return false
     */
     ...
     * @return if headers is not empty will or headers contain configKeys value will acknowledge is true or else it will throw exception
     */
    ...
    /**
     *
     * Writes data to a new CSV file based on the given List of objects and JsonConfigModel configuration. Returns a ByteArrayInputStream containing the new CSV file.
     *
     * @param data - the List of objects to write to the CSV file
     * @param excelConfigModel - the configuration settings for the CSV file, including the column headers
    ...
    public static <T> ByteArrayInputStream writeToCSV(List<T> data, ExcelConfigModel excelConfigModel) {
        ...
        } catch (IOException | NoSuchMethodException | SecurityException | IllegalAccessException | IllegalArgumentException | InvocationTargetException ex) {
     ...
     */
    private static <T> String getDataByMethod(T t, String key) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
